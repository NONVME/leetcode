...
class Solution:
    def rearrangeArray(self, nums: List[int]) -> List[int]:
        ...
        while positive_nums and negative_nums:
            rearranged_nums.append(positive_nums.pop(0))
            rearranged_nums.append(negative_nums.pop(0))
        
        if positive_nums:
            rearranged_nums.extend(positive_nums)
        elif negative_nums:
            rearranged_nums.extend(negative_nums)
